...
public class VistaResultados extends javax.swing.JFrame {
    ...
    public VistaResultados(int ntest) {
        ...
        modeloTabla = new DefaultTableModel(new Object[] { Messages.getString("DNI"), Messages.getString("Fecha"),"ID_TEST",Messages.getString("Aciertos"),Messages.getString("Fallos"),Messages.getString("Puntuacion") }, 0);
